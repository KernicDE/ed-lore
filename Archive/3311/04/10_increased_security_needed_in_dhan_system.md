...
date: '3311-04-10'
source: API
summary: The Dhan Empire League requests pilot assistance to combat a spike in piracy
  across the system's planetary rings.
player_impact: Independent combat pilots registered at Kidd Station and eliminated
  criminals, collecting bounties to combat the piracy spike in Dhan's planetary rings.
persons:
- Harald Gomes
groups:
- Dhan Empire League
...
technologies:
- Corsair
modern_impact: Harald Gomes's admission that 'the Imperial navy is occupied in other
  areas' reveals post-war military overstretch, while Gutamaya's deployment of observers
  to track Corsair performance in live combat represents a new form of product testing
  in the field — real-world data collection disguised as corporate interest.
legacy_weight: 2
significance: low
related_uuids:
