...
date: '3303-12-01'
source: GitHub
summary: The Rogue Runners, an independent group based in the Run system, have announced plans to restore and expand Leif Enterprise, an asteroid base. The renovated base aims to become a manufacturing centre for high-end ships and modules. Founder Autumn Leif stated they hope to reinforce the superstructure with meta-alloys to make it resistant to Thargoid Sensor effects.
player_impact: Pilots can deliver meta-alloys, platinum, and building fabricators to Smithport in the Run system. A kill order is active on wanted ships to protect traders.
persons:
- Autumn Leif
groups:
- Rogue Runners
...
modern_impact: The Rogue Runners' meta-alloy reinforced asteroid base demonstrates civilian efforts to harden infrastructure against Thargoid interference.
legacy_weight: 5
significance: high
---
