...
date: '3301-05-30'
source: GitHub
summary: After five days with no trace of Starship One, Lieutenant Barringer of the
  Federal Transport Safety Administration stated the disappearance appeared caused
  by a major malfunction in the Frame Shift Drive's safety systems. A power surge
  followed by four rapid system failures resulted in catastrophic explosion. While
  similar individual failures had occurred before, each previously caused drive shutdown
  rather than entry into hyperspace. No evidence of tampering was found and all pre-flight
  checks passed.
player_impact: None directly; the official accident theory was accepted despite parallels
  to the Antares disaster, though many remained sceptical.
persons:
- Lieutenant Barringer
groups:
...
modern_impact: The official malfunction ruling closed the immediate investigation
  but fuelled decades of conspiracy theories about what really happened to Starship
  One.
legacy_weight: 4
significance: high
related_uuids:
