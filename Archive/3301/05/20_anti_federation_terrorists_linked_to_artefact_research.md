...
arc_chapter: "The Canonn emerges"
modern_impact: >
  The emergence of 'The Canonn' as a terrorist group using bio-waste dumping
  to pressure the Federation marks a dark turn in the Unknown Artefact
  controversy. Arcanonn's carefully worded response — "I do not condone such
  methods but I can certainly sympathise" — walks a dangerous line between
  scientific advocacy and tacit support for extremism. His appeal for cross-
  faction petitioning and collaboration with Lyran Betar shows he still
  believes in institutional pressure, but the Canonn's existence proves that
  some Commanders have lost patience with his approach.
legacy_weight: 4
---
