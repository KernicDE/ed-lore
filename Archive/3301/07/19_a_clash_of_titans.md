...
arc_id: imperial-history
arc_chapter: "First war detailed"
modern_impact: >
  This article provides tactical detail on the first Federal-Imperial
  war, revealing how Achenar's pack-hunting formation defeated Morgan's
  fleet despite overwhelming logistical disadvantages. The description
  of the Great Battle of Liberation — every ship pressed into service —
  establishes the Empire's martial culture as born from necessity, not
  mere aggression. The 50 years of skirmishing that followed created
  the permanent division between Federation and Empire that defines
  galactic politics to this day.
legacy_weight: 4
---
