...
date: '3301-06-30'
source: GitHub
summary: A devastating outbreak aboard Newton Dock in BD-02 4304 has closed hundreds
  of businesses and quarantined thousands. The illness of unknown origin is spreading
  across the region with reports from surrounding systems suggesting wider contamination.
  Chief Medical Officer Carl Simmons warned the outbreak is spreading at an alarming
  rate and advised residents to stay home while travellers avoid the area. Almost
  27 million residents are now at risk from disease, famine or both. Symptoms include
  vomiting blood, excessive sweating, sores and intense dizziness.
player_impact: Pilots are advised to avoid the BD-02 4304 region. The outbreak is
  spreading rapidly with unknown transmission vectors.
persons:
- Carl Simmons
groups: []
locations:
