---
uuid: ebe5ac2b-54e3-5d3b-a7d3-91ccae332ab6
title: More Emperor's Dawn Bases Found
slug: more_emperors_dawn_bases_found
date: '3301-10-08'
source: GitHub
summary: 'The Imperial Internal Security Service identified five additional systems
  containing Emperor''s Dawn bases: Namarii, Tabaldak, LTT 874, Shambhala, and Svari.
  Senator Denton Patreus, leading the campaign against the insurgents, publicly announced
  the locations and vowed to crush the organization. The Empire had already eradicated
  a cell in Maausk.'
player_impact: Pilots can support Imperial forces in campaigns against Emperor's Dawn
  bases in the identified systems. Combat pilots are needed to help destroy the insurgent
  outposts.
persons:
- Denton Patreus
groups:
