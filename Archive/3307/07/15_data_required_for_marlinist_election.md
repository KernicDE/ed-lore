...
date: '3307-07-15'
source: API
summary: Rival candidates Verity Dexter and Kayode Tau request data deliveries to
  support their campaigns for Marlinist Consulate prime consul. Dexter promises to
  negotiate peace with the NMLA while Tau focuses on sustaining the colonies' independence.
  The superpowers recognise the Marlinist Consulate as an ambassadorial body.
player_impact: Pilots delivered anomalous bulk scan data and unusual encrypted files
  to Stillman Hub in HIP 22550 (Dexter) or Tilman Point in Hyades Sector RO-P b6-2
  (Tau).
persons:
- Lorcan Scordato
- Verity Dexter
...
modern_impact: The election campaign reveals the deep split within Marlinist politics
  between those seeking engagement with the Empire through the NMLA and those pursuing
  independent republican ideals, a tension that shapes the colonies' future.
legacy_weight: 4
significance: medium
related_uuids:
