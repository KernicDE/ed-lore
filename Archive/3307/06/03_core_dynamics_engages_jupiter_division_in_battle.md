...
date: '3307-06-03'
source: API
summary: Core Dynamics and its ally the Silver Legal Group battle Jupiter Division
  in the Ts'ao Tach system. CEO Owen McKenna vows to wipe out Rochester's 'deranged
  cult' while Jupiter Division VP Blanca Carbonell calls for supporters to defend
  corporate rule.
player_impact: Pilots were invited to support either Core Dynamics/Silver Legal Group
  or Jupiter Division in the Ts'ao Tach system.
persons:
- Owen McKenna
- Jupiter Rochester
- Blanca Carbonell
...
modern_impact: The second Jupiter Division conflict becomes a decisive test of the
  corporatist movement's viability without its imprisoned founder, with political
  commentators predicting it will determine whether corporate rule remains a viable
