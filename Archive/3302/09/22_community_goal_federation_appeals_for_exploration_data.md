...
date: '3302-09-22'
source: GitHub
summary: The Federation has issued a public appeal for exploration data in the Pleiades
  Nebula, coordinated by the Pleiades Resource Enterprise, to gather comprehensive
  information following the discovery of possible non-human wreckage.
player_impact: Pilots can sweep the Pleiades Nebula and deliver exploration data to
  Pre Logistics Support Gamma in the Pleiades Sector IH-V C2-5 system for generous
  rewards.
persons: []
groups:
...
modern_impact: Federal gathering of Pleiades exploration data accelerates mapping
