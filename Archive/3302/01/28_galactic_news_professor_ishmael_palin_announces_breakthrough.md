...
summary: Professor Ishmael Palin confirmed that Unknown Artefacts are the definitive
  cause of the starport malfunctions. He revealed that UAs can self-repair by extracting
  metals from their surroundings, including ship hulls and station superstructures,
  which explains the damage. Whether meta-alloys can counter this process is still
  under investigation.
player_impact: Pilots should handle Unknown Artefacts with extreme caution, as even
  minor damage triggers a self-repair mechanism that extracts metals from nearby structures.
  Meta-alloy research continues at Obsidian Orbital.
persons:
- Ishmael Palin
locations:
- Obsidian Orbital
