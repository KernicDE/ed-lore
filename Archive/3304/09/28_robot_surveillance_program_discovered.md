...
date: '3304-09-28'
source: GitHub
summary: FSS technicians discover a concealed surveillance program in Lloyd Hardacre's
  personal administration robot. Lieutenant Inspector Ramesh Thorne explains the program
  covertly copied illegal data, and a malfunction caused it to appear during a company
  presentation. The working theory is that Hardacre was targeted by an undercover
  spy operation, not coordinated by legal authorities. The Achilles Corporation PA912
  robot is described as relatively primitive and incapable of independent behaviour,
  suggesting comprehensive reprogramming.
player_impact: None
persons:
- Ramesh Thorne
- Lloyd Hardacre
