...
date: '3304-06-15'
source: GitHub
summary: Senator Caspian Leopold launches an initiative to construct a rehabilitation
  centre for civilians affected by heightened military action in the core systems.
  The Niflhel Corp places an open order for Cobalt, Semiconductors and Synthetic Fabrics,
  to be delivered to Biruni Port in the Niflhel system. A kill order is placed on
  wanted ships to protect traders.
player_impact: Independent pilots can deliver commodities to Biruni Port in the Niflhel
  system. The campaign runs for one week.
persons:
- Caspian Leopold
groups:
- Niflhel Corp
...
- humanitarian
- war
modern_impact: Leopold's refugee centre demonstrates how individual senators can mobilise
  resources for humanitarian relief amid the ongoing Thargoid conflict.
legacy_weight: 5
significance: high
related_uuids:
