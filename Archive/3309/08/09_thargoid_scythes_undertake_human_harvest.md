...
date: '3309-08-09'
source: API
summary: Aegis designates the new 'Scythe' class hunter, which hyperdicts ships and
  extracts living passengers via hull-breaching strikes and recovery drones.
...
modern_impact: Tanner's chilling description — 'A Scythe's initial attack mirrors
  that of its Glaive cousin... It then launches a unique strike to makes passenger
  cabins and cargo holds uninhabitable. The resulting escape pods are rapidly drawn
  onboard' — is clinical horror. Anderson's connection to the Dedicant — 'it now seems
  likely that the Dedicant's population was forced to abandon the megaship and subsequently
  abducted en masse by these vessels' — solves that mystery. Her speculation about
  'harvesting us in the same way as obtaining meta-alloys' frames the abduction as
  resource extraction.
legacy_weight: 5
significance: high
related_uuids:
