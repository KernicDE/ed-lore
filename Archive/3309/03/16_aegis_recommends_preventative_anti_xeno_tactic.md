...
date: '3309-03-16'
source: API
summary: Aegis proposes a preventative defense strategy — protecting systems at threat
  of invasion rather than only fighting fleets that have already arrived — with Orthrus
  ships identified as key to invasion preparation.
...
modern_impact: Varga's strategic insight — 'The effort required to repel an invasion
  fleet is far higher than dissuading that fleet from entering a system in the first
  place' — is a military axiom. The theory that Thargoids take a 'path of least resistance'
  approach is actionable intelligence. The specific identification of Orthrus vessels
  as 'key to prepping systems for invasion' and that 'invading Thargoid vessels know
  exactly where to emerge from hyperspace' provides tactical targets.
legacy_weight: 5
significance: high
related_uuids:
