...
date: '3308-06-29'
source: API
summary: The final instalment traced Salvation's rise from Aegis's shutdown through
  the Proteus Wave campaign. INRA logs in DG Canum Venaticorum revealed Dr Caleb Wycherley's
  identity as 'the Witch', validating Aegis's theory that Salvation and Azimuth's
  founder were the same person.
player_impact: No new call to action in this article, but pilots had been supporting
  Salvation's superweapon campaigns and Taurus Mining Ventures supply runs throughout this period.
modern_impact: The revelation of Salvation's true identity as Dr Caleb Wycherley fundamentally
  reshaped understanding of the Second Thargoid War's architect and his 200-year vendetta
  against the aliens.
legacy_weight: 3
significance: high
persons:
